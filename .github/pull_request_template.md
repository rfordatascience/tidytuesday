...
If this pull request is related to a particularly issue, please add "Closes #XXX" (where XXX is the issue number) to this description.
-->

Usability:

- [ ] This dataset has not already been used in TidyTuesday.
- [ ] The dataset is less than 20 MB when saved as a tidy CSV (each CSV is less than 20 MB, if there are multiple).
