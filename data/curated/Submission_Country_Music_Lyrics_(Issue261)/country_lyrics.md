...
|entered_top_30_in            |double    |The date or month/year the track first entered the Top 30 Country Airplay chart. |
...
|rough_order                  |double    |Original entry index or sequence number assigned during data collection. |
