...
export_url <- paste0("https://docs.google.com/spreadsheets/d/", sheet_id, "/export?format=xlsx")
...
country_lyrics <- read.xlsx(temp_xlsx, sheet = 1) |>
  ...
  select(
    ...
    rules_top_30_country_airplay  = `RULES!!!!.Top.30.Country.Airplay.From.March.2014-March.2017`
    )
